            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <center></center>    <h3 class="card-title">Liste des produits</h3>
                            <a href="{{ route('pdfListeProduit') }}" class="btn btn-info">Imprimer liste produits</a>
                        </div>
                    </div>
                    <div class="">
                        <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('editproduit',['id'=> $p->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="{{ route('deleteproduit',['id'=> $p->id]) }}" class="btn btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer ce produit ?')"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
